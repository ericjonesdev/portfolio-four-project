...
urlpatterns = [
    ...
    path('user_profile/<int:user_pk>/', UserProfiileDetailView.as_view(), name='user_profile'),
    ...
    path('new_post/', views.UserBlogPostCreateView, name='create_post'),
    path('<slug:slug>/edit/', views.UserBlogPostUpdateView, name='edit_post'),
]
